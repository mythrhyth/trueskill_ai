...
[4] Fusion Agent → Combine and deduplicate signals
    ↓
[5] Validator Agent → Verify authenticity
    ↓
[6] Scoring Agent → Assign credibility scores
    ↓
[7] XAI Agent → Generate human-readable explanations
    ↓
...
| **Validator** | Verify skill authenticity | Skills | Validated skills |
| **Scoring** | Calculate credibility | Validated skills | Skills with scores |
| **XAI** | Generate explanations | Scored skills | Explanations + summary |
